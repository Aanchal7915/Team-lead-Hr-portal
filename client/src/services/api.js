...
export const analyticsAPI = {
    ...
    getHrAnalytics: () => api.get('/analytics/hr'),
    getRankings: (params) => api.get('/analytics/rankings', { params })
};
...
export const employeeAPI = {
    ...
    getLeaves: (params) => api.get('/leaves', { params }), // assuming /api/leaves
    applyLeave: (data) => api.post('/leaves', data),
    getRankings: () => api.get('/rankings'), // assuming /api/rankings
    getSalarySlips: () => api.get('/employee/salary'), 
    updateProfile: (data) => api.put('/employee/profile', data) // handles the user profile
};
...
export const hrAPI = {
    ...
    getAttendanceLogs: (params) => api.get('/hr/attendance', { params }),
    updateAttendance: (id, data) => api.put(`/hr/attendance/${id}`, data),
    getEodReports: (params) => api.get('/hr/eod-reports', { params })
};
...
export const announcementsAPI = {
    ...
    getEmployeeAnnouncements: () => api.get('/employee/announcements')
};

// HR Salary Slips API (admin-side)
export const hrSalarySlipsAPI = {
    getAll: (params) => api.get('/salary-slips', { params }),
    preview: (params) => api.get('/salary-slips/preview', { params }),
    generate: (data) => api.post('/salary-slips', data),
    updateStatus: (id, data) => api.put(`/salary-slips/${id}`, data),
    delete: (id) => api.delete(`/salary-slips/${id}`),
    getMine: () => api.get('/salary-slips/mine')
};
