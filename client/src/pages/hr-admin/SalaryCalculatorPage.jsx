                                ...
                                <div key={record._id} className="bg-white dark:bg-gray-800 p-4 sm:p-8 rounded-[2rem] border border-gray-100 dark:border-gray-700 shadow-sm transition-all hover:shadow-md group">
                                    <div className="flex flex-col md:flex-row justify-between items-center gap-6">
                                        <div className="flex-1 space-y-4">
                                            ...
                                            <div className="bg-[#f9f9f9] dark:bg-gray-700/50 p-2.5 px-5 rounded-xl border border-gray-200 dark:border-gray-600 inline-block max-w-[200px] sm:max-w-md overflow-x-auto whitespace-nowrap scrollbar-thin scrollbar-thumb-gray-200 scrollbar-track-transparent">
