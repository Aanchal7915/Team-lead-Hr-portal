...
const Layout = ({ children, title, noPadding = false, noBackground = false }) => {
  ...
  return (
    <div className="flex h-screen bg-[#FAF9F8]">
      ...
      <div className="flex-1 overflow-auto lg:ml-64">
        ...
        <main className={`${noPadding ? '' : 'p-3 sm:p-4 lg:p-6'} ${noBackground ? '' : 'bg-transparent'} overflow-x-auto md:overflow-x-visible text-[13px] sm:text-base`}>{children}</main>
      </div>
