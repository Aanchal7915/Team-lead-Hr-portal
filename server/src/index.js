...
const startServer = async () => {
  try {
    ...
    const otherRoutes = [
      ...
      {
        path: "/api",
        file: "./routes/employeehrRoutes",
        name: "Employee HR APIs",
      },
      {
        path: "/api/hr",
        file: "./routes/hradminRoutes",
        name: "HR Admin APIs",
      },
      {
        path: "/api/announcements",
        file: "./routes/announcementRoutes",
        name: "Announcements",
      },
      {
        path: "/api/salary-slips",
        file: "./routes/salarySlipRoutes",
        name: "Salary Slips",
      },
      {
        path: "/api/hr/salary-slips",
        file: "./routes/salarySlipRoutes",
        name: "HR Admin Salary Slips",
      },
      {
        path: "/api/hr-portal/hr",
        file: "./hr-portal-backend/routes/hrRoutes",
        name: "Legacy HR Backend",
      },
      {
        path: "/api/hr-portal/salary-records",
        file: "./hr-portal-backend/routes/salarySlipRoutes",
        name: "Legacy Salary Records",
      },
      {
        path: "/api/hr-portal/employee",
        file: "./hr-portal-backend/routes/employeeRoutes",
        name: "Legacy Employee Backend",
      }
    ];
